import { BarChart3, TrendingUp, Search, FolderOpen, LogOut } from "lucide-react";
...
const tools = [
  { title: "Island Analytics", url: "/app", icon: FolderOpen, end: true },
  { title: "Discover Trends", url: "/app/discover-trends", icon: TrendingUp },
